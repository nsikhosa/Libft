...
#    Updated: 2017/07/27 13:43:51 by nsikhosa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HEADER = includes
SRC = ft_atoi.c ft_isalpha.c ft_strcmp.c ft_strcpy.c \
	  ft_strlen.c ft_strncmp.c ft_strncpy.c ft_bzero.c \
	  ft_strstr.c ft_tolower.c ft_toupper.c ft_strdup.c \
	  ft_memset.c ft_memcpy.c ft_isascii.c ft_isprint.c \
	  ft_memcmp.c ft_strcat.c ft_strncat.c ft_strlcat.c \
	  ft_isdigit.c ft_strnstr.c ft_memccpy.c ft_memchr.c \
	  ft_memmove.c ft_isalnum.c ft_strchr.c ft_strrchr.c \
	  ft_putchar.c ft_putstr.c ft_memalloc.c ft_memdel.c \
	  ft_strclr.c ft_strequ.c ft_strnequ.c ft_putendl.c \
	  ft_striter.c ft_striteri.c ft_strnew.c ft_strmap.c \
	  ft_strmapi.c ft_strsub.c ft_strtrim.c ft_putnbr.c \
	  ft_putchar_fd.c ft_putstr_fd.c ft_putnbr_fd.c \
	  ft_putendl_fd.c ft_strjoin.c ft_itoa.c ft_strdel.c \
	  ft_strsplit.c
LFLAGS = ar rcs
NAME = libft.a
OBJ = ft_atoi.o ft_isalpha.o ft_strcmp.o ft_strcpy.o ft_strlen.o \
	  ...
	  ft_strjoin.o ft_itoa.o ft_strdel.o ft_strsplit.o
